...
This is a small sample, so I report both mean and median payoff assumptions. That matters because biotech returns can be extremely skewed. One large approval can pull the mean far above the median, while a single disappointing label detail can turn an approval into a negative stock reaction.
